...
const grammarsDir = toolsDir.cwd('..', 'extension', 'languages', 'grammars')
const dataDir     = toolsDir.cwd('generated')
const grammarFile = 'wow-lua.tmLanguage.json'
...
// APIs
const luaApis = require(toolsDir.path('generated', 'luaFunctions.js')),
 ...
 *****************************************************************************/
console.info(`Generating ${grammarsDir.path(grammarFile)}...`)

// Prepare our grammar template
const grammar = toolsDir.read('wow-lua.tmLanguage-template.json', 'json')
...
grammarsDir.write('wow-lua.tmLanguage.json', grammar, { jsonIndent: 4 })
console.info('Done.')
